...
#   ID,                                    NAME,                                 TYPE, SUBTYPE, SWITCHTYPE, OPTIONS, MODBUSNAME,                           MODBUSSCALE, FORMAT,    PREPEND_ROW, PREPEND_MATH, APPEND_MATH, LOOKUP,                              MATH
    ...
    [BatteryUnit.LIFE_EXPORT_ENERGY_COUNT, "Total Exported Energy",              0xF3, 0x21,    0x00,       {},      "lifetime_export_energy_counter",     None,        "{};0;{}", None,        None,         Timestamp(), None,                                None      ],
    [BatteryUnit.LIFE_IMPORT_ENERGY_COUNT, "Total Imported Energy",              0xF3, 0x21,    0x00,       {},      "lifetime_import_energy_counter",     None,        "{};0;{}", None,        None,         Timestamp(), None,                                None      ],
    ...
    [BatteryUnit.SOH,                      "State of Health",                    0xF3, 0x06,    0x00,       {},      "soh",                                None,        "-1;{}",   None,        None,         None,        None,                                None      ],
    [BatteryUnit.SOE,                      "State of Energy",                    0xF3, 0x06,    0x00,       {},      "soe",                                None,        "-1;{}",   None,        None,         None,        None,                                None      ]
]