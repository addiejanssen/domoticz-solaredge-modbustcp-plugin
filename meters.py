...
from helpers import Average, Delta
...
SINGLE_PHASE_METER = [
#   ID,                                 NAME,                             TYPE, SUBTYPE, SWITCHTYPE, OPTIONS,             MODBUSNAME,                MODBUSSCALE,            FORMAT,   PREPEND_LOOKUP, PREPEND_MATH, LOOKUP, MATH
    ...
    [MeterUnit.L1_EXPORT_ENERGY_ACTIVE, "L1 Exported Energy (Active)",    0xF3, 0x1D,    0x04,       {},                  "l1_export_energy_active", "energy_active_scale",  "{};{}",  None,           Delta(),      None,   None      ],
    ...
    [MeterUnit.L1_IMPORT_ENERGY_ACTIVE, "L1 Imported Energy (Active)",    0xF3, 0x1D,    0x00,       {},                  "l1_import_energy_active", "energy_active_scale",  "{};{}",  None,           Delta(),      None,   None      ],
]
...
#   ID,                                 NAME,                             TYPE, SUBTYPE, SWITCHTYPE, OPTIONS,             MODBUSNAME,                MODBUSSCALE,            FORMAT,   PREPEND_LOOKUP, PREPEND_MATH, LOOKUP, MATH
    ...
    [MeterUnit.EXPORT_ENERGY_ACTIVE,    "Total Exported Energy (Active)", 0xF3, 0x1D,    0x04,       {},                  "export_energy_active",    "energy_active_scale",  "{};{}",  MeterUnit.POWER, None,      None,   None      ],
    [MeterUnit.L1_EXPORT_ENERGY_ACTIVE, "L1 Exported Energy (Active)",    0xF3, 0x1D,    0x04,       {},                  "l1_export_energy_active", "energy_active_scale",  "{};{}",  None,           Delta(),      None,   None      ],
    [MeterUnit.L2_EXPORT_ENERGY_ACTIVE, "L2 Exported Energy (Active)",    0xF3, 0x1D,    0x04,       {},                  "l2_export_energy_active", "energy_active_scale",  "{};{}",  None,           Delta(),      None,   None      ],
    [MeterUnit.L3_EXPORT_ENERGY_ACTIVE, "L3 Exported Energy (Active)",    0xF3, 0x1D,    0x04,       {},                  "l3_export_energy_active", "energy_active_scale",  "{};{}",  None,           Delta(),      None,   None      ],
    [MeterUnit.IMPORT_ENERGY_ACTIVE,    "Total Imported Energy (Active)", 0xF3, 0x1D,    0x00,       {},                  "import_energy_active",    "energy_active_scale",  "{};{}",  MeterUnit.POWER, None,      None,   None      ],
    [MeterUnit.L1_IMPORT_ENERGY_ACTIVE, "L1 Imported Energy (Active)",    0xF3, 0x1D,    0x00,       {},                  "l1_import_energy_active", "energy_active_scale",  "{};{}",  None,           Delta(),      None,   None      ],
    [MeterUnit.L2_IMPORT_ENERGY_ACTIVE, "L2 Imported Energy (Active)",    0xF3, 0x1D,    0x00,       {},                  "l2_import_energy_active", "energy_active_scale",  "{};{}",  None,           Delta(),      None,   None      ],
    [MeterUnit.L3_IMPORT_ENERGY_ACTIVE, "L3 Imported Energy (Active)",    0xF3, 0x1D,    0x00,       {},                  "l3_import_energy_active", "energy_active_scale",  "{};{}",  None,           Delta(),      None,   None      ]
]
