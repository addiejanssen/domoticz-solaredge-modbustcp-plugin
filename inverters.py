...
#   ID,                            NAME,                TYPE,  SUBTYPE,  SWITCHTYPE, OPTIONS,                MODBUSNAME,        MODBUSSCALE,            FORMAT,    PREPEND,        LOOKUP,                                MATH
    ...
    [InverterUnit.RRCR_STATE,         "RRCR State",         0xF3, 0x13,    0x00,       {},                  "rrcr_state",         None,                   "{}",     None,                  None,                                 None      ],
    [InverterUnit.ACTIVE_POWER_LIMIT, "Active Power Limit", 0xF3, 0x06,    0x00,       {},                  "active_power_limit", None,                   "{:.2f}", None,                  None,                                 Average() ],
    [InverterUnit.COSPHI,             "cos-phi",            0xF3, 0x13,    0x00,       {},                  "cosphi",             None,                   "{}",     None,                  None,                                 None      ]
